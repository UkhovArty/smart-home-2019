...
public class RemoteControlConfiguration {
    ...
    @Bean
    public RemoteControl remoteControl(AlarmToActiveStateSettingAction activate, @Qualifier("LightsOn") AllLightsSwitchAction LightsOn, @Qualifier("LightsOff") AllLightsSwitchAction LightsOff, CloseHallDoorAction closeHallDoor, AlarmActivationAction alarm, HallLightsSwitchingAction hallLightsOn, RemoteControlRegistry remoteControlRegistry) {
